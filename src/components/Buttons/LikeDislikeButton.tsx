  ...
  return (
    <div className="flex-end isolate  inline-flex rounded-md shadow-sm">
      <button
        ...
        ${
          userChoice.like
            ? "group bg-violet-600 text-white hover:text-gray-900 group-hover:stroke-gray-900"
            : "group bg-white text-gray-600 hover:text-violet-600 group-hover:stroke-violet-600"
        }`}
      >
        <ThumbsUp
          className={`group h-4 w-4 shrink-0 ${
            userChoice.like
              ...
              : "group stroke-gray-600 group-hover:stroke-violet-600"
          }`}
        />
      ...
      <button
        ...
        ${
          userChoice.dislike
            ? "group bg-red-600 text-white hover:text-gray-900 group-hover:stroke-gray-900"

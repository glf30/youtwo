    ...
    fetch(
      ...
      .then((data) => {
        if (
          ...
          // only include title/description if changed
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="mt-2">
                              <textarea
                                ...
                                onChange={handleInputChange}
                                className="block w-full rounded-md border-0 p-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6"
                              />
                            </div>
                          </div>
                        </div>

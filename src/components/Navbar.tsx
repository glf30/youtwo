...
export default function Navbar({ children }: NavbarProps) {
  ...
  const handleSearch = async () => {
    try {
      ...
      console.error("Error navigating to search page");
    }
  };
  ...
  return (
    <>
      <div className="fixed z-50 w-full border border-gray-200 bg-white shadow-sm">
        <div className="mx-auto flex max-w-full items-center px-6 lg:px-16 xl:grid xl:grid-cols-12">
          <div className="flex flex-shrink-0 items-center lg:static xl:col-span-2">
            <Link href="/#" aria-label="Home">
              <Image src={YouTwoLogo} alt="logo" height={40} width={120} />
            </Link>
          </div>
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  ...
                  <input
                    id="search"
                    name="search"
                    className="block w-full rounded-md border-0 py-1.5 pl-10 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6"
                    placeholder="Search"
                    type="search"
          ...
          <div className="m-0 hidden w-max px-0 lg:flex lg:items-center lg:justify-end xl:col-span-2">
            ...
            <Menu as="div" className="relative ml-5 flex-shrink-0">
              <div>
                <Menu.Button className="flex rounded-full focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2">
                  {sessionData ? (

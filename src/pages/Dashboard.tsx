...
import { VioletEye, VioletUserCheck, VioletHeart } from "~/components/Icons/Icons";
  ...
  const stats: StatsItem[] = [
    {
      ...
      icon: (className) => <VioletEye className={className} />,
    },
    {
      name: "Total followers",
      stat: data?.totalFollowers?.toString() || "0",
      icon: (className) => <VioletUserCheck className={className} />,
    },
    {
      name: "Total likes",
      stat: data?.totalLikes?.toString() || "0",
      icon: (className) => <VioletHeart className={className} />,
    },
  ];
